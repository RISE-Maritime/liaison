...
mod tests {
    ...
    #[test]
    fn test_parse_query_payload_empty() {
        // Note: This test would require creating a mock Query object
        // which is complex due to Zenoh's API. In practice, these handlers
        // are tested through integration tests with actual Zenoh sessions.
    }

    #[test]
    fn test_status_conversion() {
        // Verify status_to_proto works correctly
